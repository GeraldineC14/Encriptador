...
function resetOutput(output) {
  ...
  const nomensaje = d.querySelector(".nomensaje");
  const ingreseme = d.querySelector(".ingreseme");
  if (img != null) {
    img.style.display = "none";
    nomensaje.style.display = "none";
    ingreseme.style.display = "none";
  ...
  <button id="btn__copy" class="btn__copy" data-clipboard-action="copy" onclick="clickTooltip()" onmouseout="outTooltip()" data-clipboard-target="#output__text">
      ...
      <i class="bi bi-clipboard-check-fill copyico"></i>
    </button>
  </div>
  </p>
  `;
